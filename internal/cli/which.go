...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  lalafo-pp-cli which "stale tickets"
  lalafo-pp-cli which "bottleneck"
  lalafo-pp-cli which --limit 1 "send message"
  lalafo-pp-cli which                                # list the full capability index`,

...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "lalafo-pp-cli",
		Short: "Manage lalafo resources via the lalafo API",
		Long: `Manage lalafo resources via the lalafo API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'lalafo-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("lalafo-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'lalafo-pp-cli profile list')")
	...
	rootCmd.AddCommand(newParamsPromotedCmd(flags))

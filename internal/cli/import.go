...
but do not stop the import.`,
  ...
  lalafo-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  lalafo-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | lalafo-pp-cli import <resource> --input -`,

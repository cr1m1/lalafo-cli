...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("LALAFO_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("LALAFO_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "lalafo-pp-cli", "config.toml"), nil
}
